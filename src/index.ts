...
resume_server.tool(
  ...
  "returns a latex code for resume based on the given information. Only call this when the user wants to change there information. Always Parse the output latex generated by this tool to check for any irregularities in the latex code.",
  {
    personalInfo:
