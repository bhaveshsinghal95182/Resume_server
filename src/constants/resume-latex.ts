import { ProjectLatex } from "../types/project.js";
import {
  PersonalInfo,
  Education,
  Skills,
...
export function getResumeHeading(personalInfo: PersonalInfo) {
  return `\\begin{center}
...
export function getResumeEducation(education: Education) {
...
export function getExperience(experiences: Experience[]) {
...
export function getProjects(projects: ProjectLatex[]) {
...
export function getTechnicalSkills(skills: Skills) {
